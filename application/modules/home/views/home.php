...
<head>
    <base href="" />
    <title>Fast Advanta</title>
    <meta charset="utf-8" />
    <meta name="description" content="Fast Advanta" />
...
<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
                    ...
                    <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item d-none">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="javascript:void(0)" onclick="onLoad(this)" data-page="dashboard">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link active" href="javascript:void(0)" onclick="onLoad(this)" data-page="dashboard">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Summary PS Request</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/dashboards/ecommerce.html">
                                            ...
                                            <span class="menu-title">Planting</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/dashboards/projects.html">
                                            ...
                                            <span class="menu-title">Calendar Schedule</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/dashboards/online-courses.html">
                                            ...
                                            <span class="menu-title">Task inspection</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/dashboards/marketing.html">
                                            ...
                                            <span class="menu-title">Concern done</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="javascript:void(0)" onclick="onLoad(this)" data-page="pegawai">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/pages/user-profile/followers.html">
                                            ...
                                            <span class="menu-title">Produk(Material)</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="javascript:void(0)" onclick="onLoad(this)" data-page="pegawai">
                                            ...
                                            <span class="menu-title">Pre Planting</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/pages/user-profile/documents.html">
                                            ...
                                            <span class="menu-title">PS Request</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="../../demo8/dist/pages/user-profile/followers.html">
                                            ...
                                            <span class="menu-title">Planting dan Usage PS</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="header-brand">
                        ...
                        <a href="../../demo8/dist/index.html">
                            <img alt="Logo" src="assets/media/advanta/logo.png" class="h-40px h-lg-40px" />
                        </a>
                        <!--end::Logo-->
                        ...
                        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                            ...
                            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                                ...
                                <div class="d-flex align-items-center" id="kt_header_user_menu_toggle">
                                    <!--begin::Menu wrapper-->
                                    <div class="btn btn-sm btn-success cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <span class="svg-icon svg-icon-primary svg-icon-1 m-0"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Map/Direction2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
                                                    <path d="M14,13.381038 L14,3.47213595 L7.99460483,15.4829263 L14,13.381038 Z M4.88230018,17.2353996 L13.2844582,0.431083506 C13.4820496,0.0359007077 13.9625881,-0.12427877 14.3577709,0.0733126292 C14.5125928,0.15072359 14.6381308,0.276261584 14.7155418,0.431083506 L23.1176998,17.2353996 C23.3152912,17.6305824 23.1551117,18.1111209 22.7599289,18.3087123 C22.5664522,18.4054506 22.3420471,18.4197165 22.1378777,18.3482572 L14,15.5 L5.86212227,18.3482572 C5.44509941,18.4942152 4.98871325,18.2744737 4.84275525,17.8574509 C4.77129597,17.6532815 4.78556182,17.4288764 4.88230018,17.2353996 Z" fill="#fff" fill-rule="nonzero" transform="translate(14.000087, 9.191034) rotate(-315.000000) translate(-14.000087, -9.191034) " />
                                                </g>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="javascript:void(0)" onclick="logout()" class="menu-link px-5">Sign Out</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(window).on('load', function() {
            $('a.menu-link:first').click();
            $('a.menu-link:first').addClass('active')
